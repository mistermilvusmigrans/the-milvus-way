...
In "Beauty is Downstream of Love" ([library/lifeblood-essays.odt](./lifeblood-essays.odt)), I defined love as follows:

> Hence, we can outline the 2 essential components of love: (1) moral (i.e. value-oriented) commitment to a particular object and (2) internalisation of the moral context into the psychological context, whereby our commitment is not merely obligation-based but also (at least in part) internally-driven.

Particularity is a key element of it:

> Here, note that particularity is key, since we cannot commit “generally” or “vaguely”, since commitment involves concretisation of intent through consistent action; here, note that even when loving a category/form of engagement (e.g. “humanity”, “respect for human rights”, etc.), we are loving a particular category/form of engagement for particular reasons through particular actions.

Internalisation is another key element of it:

> Furthermore, note that if our commitment is to reason and the values we identify through reason, commitment both precedes and promotes internalisation. Also, of course, internalisation, being the source of internally-driven motivation, promotes commitment. Hence, these components are mutually reinforcing while also being logically predicated on moral commitment (hence, you can indeed grow to love someone you value, given consistency in your moral commitment).

The troubling question, however, is:

*Is this people would understand when I say "love"?*

You see, a shared word used with an unshared context is meaningless for communication, since words are just marks on a map, and without the map, the marks mean nothing. Let us see what "love" actually refers to as a concept:
...
When I see how this hapless word is dragged around, sometimes carried gracefully by well-meaning souls, sometimes tortured into perversion by fools and fanatics, I wonder what the damn point of this word even is. Because, at this point, when someone says they "love" something or someone, even when the external context is clear, the internal context is often not so clear: more often than not, either their meaning is unclear or their meaning is something that comes with a whole framework that may or may not be worthless or even vile. When a word can mean almost anything from mystical inspiration to obsession to mutual affection, it means almost nothing to me, and moreover, it is almost dangerous for me to use it when I have no idea what kind of frame of reference the other person has when understanding this word.

Thus, I do not want to deal with "love".
...
Now, you may say, "Wait, can you not add qualifications to love, just as we add qualifications to, say, science, to differentiate - quite precisely - between its branches?" Yes, you would be right, and that is a worthwhile thing to do, because "love", as I have proven with my own definition, is something that can be well-defined and useful. The problem I have with "love", however, is how loaded it is with moral baggage due to inherited systems (e.g. religion, culture, etc.) or idiosyncracy (e.g. the way "love" differs from individual to individual), much of which I disagree with. So, until there is enough of a shift in the shared meaning of "love" and its categories, I would be very hesitant to use this word unless I am very clear what it means to me and the one I am saying it to.